...
export default function ApiKeysPage() {
  ...
  const maskKey = (key: string) =>
    `${key.slice(0, 8)}${"•".repeat(28)}${key.slice(-4)}`;
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-2 lg:pt-0">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Each key links ESP32 devices to your account. Flash the key via the captive portal.
          </p>
        </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="p-4 flex gap-3 items-start">
          ...
          <div className="text-sm text-muted-foreground space-y-1">
            <p>
              <span className="font-semibold text-foreground">How it works:</span> Create an API key
              and give it a label. Enter it in your ESP32&apos;s captive portal. Multiple ESP32 devices
              can share the same key — they&apos;ll all appear under your account.
            </p>
            <p>
              Keep your keys private. Revoking a key disconnects all devices using it.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <Card className="border-dashed">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-6 max-w-xs mx-auto">
              Create your first API key to start connecting ESP32 devices.
            </p>
            <Button onClick={() => setCreateOpen(true)}>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0 space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <Badge variant={k.active ? "online" : "offline"}>
                      ...
                      <div className="flex items-center gap-2">
                        <code className="mono text-xs bg-muted px-2.5 py-1.5 rounded-md text-foreground flex-1 truncate">
          ...
          {createdKey ? (
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-primary/10 border border-primary/20">
                ...
                <div className="flex items-center gap-2">
                  <code className="mono text-xs bg-background px-3 py-2 rounded-md border flex-1 break-all text-foreground">
                    {createdKey}
                  </code>
                  <button
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onKeyDown={(e) =>
                    e.key === "Enter" && newLabel && createKey.mutate({ label: newLabel })
                  }
                  autoFocus
                />
              </div>
      ...
      <Dialog open={!!revokeId} onOpenChange={(o) => !o && setRevokeId(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This will immediately disconnect all ESP32 devices using this key. The key will be
              deactivated but kept for reference. You can delete it afterwards.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
      ...
      <Dialog open={!!deleteId} onOpenChange={(o) => !o && setDeleteId(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This will permanently delete the key and unlink all devices associated with it.
