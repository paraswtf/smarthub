			...
			<div className="max-w-[900px] mx-auto">
				...
				>
					<div
						...
						style={{ background: "radial-gradient(circle at 80% 10%, rgba(18,201,132,0.1) 0%, transparent 60%)" }}
					/>

					<div className="relative z-10">
						<div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[rgba(18,201,132,0.2)] bg-[rgba(18,201,132,0.07)] text-[12px] font-semibold text-[#12c984] tracking-[1px] uppercase mb-8">Free & Open Source</div>

						<h2
							className="font-['Sora'] font-extrabold mb-5"
							style={{ fontSize: "clamp(28px, 4vw, 44px)", color: "#e8f0ea" }}
						>
