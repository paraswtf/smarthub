		...
		>
			<div className="max-w-[1200px] mx-auto">
				<div className="text-center mb-16 reveal">
					...
					<p
						className="text-[16px] max-w-[480px] mx-auto mt-5 leading-relaxed"
						style={{ color: "#7a9080" }}
					>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
					{STEPS.map(({ n, title, desc }) => (
						<div
							key={n}
							className="reveal land-card p-7 h-full"
						>
							<div
								className="font-['Sora'] font-extrabold text-[44px] leading-none mb-5 select-none"
								style={{ color: "rgba(18,201,132,0.18)" }}
							>
								{n}
							</div>
							<h3
								className="font-['Sora'] font-bold text-[17px] mb-3"
								style={{ color: "#e8f0ea" }}
							>
								{title}
							</h3>
