...
export default function HeroSection() {
	...
	return (
		<section
			ref={sectionRef}
			className="min-h-screen flex flex-col items-center justify-center text-center px-6 md:px-10 pt-[120px] pb-20 relative overflow-hidden"
		>
			{/* Deep green glow */}
			<div
			...
			<div className="absolute inset-0 pointer-events-none overflow-hidden">
				{[
					...
					<div
						...
						style={{ ...style, background: "linear-gradient(to bottom, rgba(18,201,132,0.2), transparent)" }}
					/>
				))}
			</div>
			...
			<div className="relative z-10 max-w-[860px] reveal">
				{/* Badge */}
				<div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[rgba(18,201,132,0.25)] bg-[rgba(18,201,132,0.07)] text-[12px] font-semibold text-[#12c984] tracking-[1px] uppercase mb-8">Open Source · ESP32 · Home Automation</div>

				<h1
					className="font-['Sora'] font-extrabold leading-[1.06] mb-6"
					style={{ fontSize: "clamp(40px, 7vw, 78px)", color: "#e8f0ea" }}
				>
				...
				<div className="flex flex-wrap gap-4 justify-center">
					...
					<a
						href="https://github.com/paraswtf/esp-hub"
						target="_blank"
				...
				<div
					...
					style={{ borderTop: "1px solid rgba(18,201,132,0.12)" }}
				>
					{[
						...
						>
							<p
								className="font-['Sora'] font-extrabold text-[28px] leading-none"
								style={{ color: "#12c984" }}
							>
								{value}
							</p>
