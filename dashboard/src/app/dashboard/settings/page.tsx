	...
	return (
		<div className="p-6 lg:p-8 space-y-6 animate-fade-in max-w-2xl mt-14 lg:mt-0">
			...
			<Card>
				...
				<CardContent className="space-y-4">
					<div className="space-y-1.5">
						...
						<Input id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="Your name" onKeyDown={(e) => e.key === "Enter" && saveName()} />
					</div>
					<div className="space-y-1.5">
						<Label>Email</Label>
			...
			<Card>
				...
				<CardContent className="space-y-4">
					{pwError && <div className="p-3 rounded-lg bg-destructive/10 border border-destructive/20 text-destructive text-sm">{pwError}</div>}
					<div className="space-y-1.5">
