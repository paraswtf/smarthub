		...
		<div className="min-h-screen flex items-center justify-center bg-background px-4">
			...
			<div className="w-full max-w-[420px] animate-slide-up">
				...
				<div className="rounded-2xl border bg-card p-8 shadow-sm">
					...
					{/* Google sign-up */}
					<Button variant="outline" className="w-full" onClick={handleGoogle} disabled={googlePending}>
						{googlePending ? (
					...
					<div className="space-y-4">
						<div className="space-y-1.5">
							...
							<Input id="name" value={form.name} onChange={set("name")} placeholder="Jane Smith" />
						</div>
						<div className="space-y-1.5">
						...
						<div className="space-y-1.5">
							...
							<Input id="confirm" type="password" value={form.confirm} onChange={set("confirm")} placeholder="Repeat password" onKeyDown={(e) => e.key === "Enter" && handleRegister()} />
						</div>

						<Button className="w-full mt-2" onClick={handleRegister} disabled={isPending}>
							{isPending ? (
								<>
