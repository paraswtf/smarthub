  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        sidebar:    { DEFAULT: "hsl(var(--sidebar))", foreground: "hsl(var(--sidebar-foreground))", border: "hsl(var(--sidebar-border))", primary: "hsl(var(--sidebar-primary))", accent: "hsl(var(--sidebar-accent))", muted: "hsl(var(--sidebar-muted))" },
